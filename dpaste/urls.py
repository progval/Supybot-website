...
urlpatterns = patterns('dpaste.views',
    ...
    url(r'^(?P<snippet_id>[a-zA-Z0-9]{4,8})/$', 'snippet_details', name='dpaste_snippet_details'),
    url(r'^(?P<snippet_id>[a-zA-Z0-9]{4,8})/delete/$', 'snippet_delete', name='dpaste_snippet_delete'),
    url(r'^(?P<snippet_id>[a-zA-Z0-9]{4,8})/raw/$', 'snippet_details', {'template_name': 'dpaste/snippet_details_raw.html', 'is_raw': True}, name='dpaste_snippet_details_raw'),
)
